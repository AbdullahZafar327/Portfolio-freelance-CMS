...
export const Projects = [
  {
    ...
    Description:"Developed a visually stunning landing page and dashboard with the capability to generate AI images, prompts, and music using the ChatGPT API. Integrated a Stripe payment system gateway with a complimentary 5-generation limit.",
    sourceCode:'https://github.com/AbdullahZafar327/AI-Saas-App',
    thumbnail:AiSaas
  },
  {
    name: 'Discord Application',
    Description:'Developed a complete Discord system including servers, channels, and channel types such as audio, video, and text. Implemented Socket.io for real-time collaboration.',
    sourceCode:"https://github.com/AbdullahZafar327/Discord-Server",
    thumbnail:discord
  },{
    name:"Ecommerce Brand UX/UI",
    Description:'Developed a lightning-fast Ecommerce system using Next.js SSR, featuring advanced payment processing and order tracking. Seamlessly integrated a Stripe payment gateway for dynamic checkout experiences.',
    sourceCode:'https://github.com/AbdullahZafar327/Ecommerce_StoreDigital',
    thumbnail:Ecommerce
  },{
    name:'Charity Collections Dashboard',
    Description:'Designed a user-friendly and intuitive UX/UI for managing charity transactions, statistics, daily, monthly, and yearly collections. Implemented interactive graphs and charts to visualize data effectively.',
    sourceCode:'https://github.com/AbdullahZafar327/Charity_fronted',
    thumbnail:Charity
  },{
    name:'Social Media Application',
    Description:'Built social media functionality for posting, liking, and searching content. Utilized React with Redux for efficient state management.',
