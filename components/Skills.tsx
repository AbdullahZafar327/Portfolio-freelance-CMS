    ...
    >
      <div className="flex flex-col">
        ...
        <div className="grid xl:grid-cols-3  grid-cols-1 items-center justify-between gap-20 ">
          {/* //First colum1 */}
          <div className="flex flex-col items-center mt-4 p-4 grid-span-1">
          ...
          {/* //Ninja Column */}
          <motion.div className="grid-span-1 w-full h-full" initial={{x:300}} whileInView={{x:0}} transition={{duration:0.5,ease:easeInOut}}>
          <Image
                    src='/ninja_1.gif'
                    alt="ninja"
                    width={30}
          ...
          <div className="flex items-center w-full justify-between gap-8 p-8">
          </div>
      </div>
    </motion.div>
  );
